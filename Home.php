...
<body>
	...
	<header class="header" id="nav">
		...
		<img src="images/prof.jpeg" class="user-pic" onclick="toggleMenu()">          
                <div class="sub-menu-wrap" id="subMenu" >
                    <div class="sub-menu">
                        <div class="user-info">
                        <img src="images/prof.jpeg">
                        <h3>Hi, <span class="username"><?php echo $_SESSION['user_name'];?></h3>
                     </div>
                     <hr>
                     <a href="#" class="sub-menu-link">
                        <i class="fa-solid fa-user"></i><p>View profile</p>
                         <span>></span>
                    </a>
                     <a href="#" class="sub-menu-link">
                     ...
                     <a href="#contact" class="sub-menu-link">
                        <i class="fa-solid fa-info"></i><p>help and support</p>
                        <span>></span>
                     </a>
		...
		<div class="box-container">
			...
			<div class="box">
				...
				<div class="content">
					<div>
						<h3>GIRAFFE</h3>
						<span> Fun Fact<br>A giraffe's neck is too short to reach the ground.</span>
					</div>
				</div>
			</div>
			...
			<div class="box">
				...
				<div class="content">
					<div>
						<h3>MONKEY</h3>
						<span> Fun Fact<br>Apes are not monkeys.</span>
					</div>
				</div>
			</div>
